...
if(isset($_POST['Submit']))
{
  ...
  $uid=intval($_GET['uid']);
$query=mysqli_query($con,"update staff set fname='$fname' ,lname='$lname' , nic='$nic', gender='$gender', address='$address', phone='$phone', email='$email' where empid='$uid'");
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <?php $ret=mysqli_query($con,"select * from staff where empid='".$_GET['uid']."'");
				...
				<div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">NIC</label>
                              <div class="col-sm-10">
